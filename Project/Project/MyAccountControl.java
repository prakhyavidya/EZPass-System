...
import javax.swing.*;
import com.vidya.*;
import com.vidya.Account;

public class MyAccountControl
{

    public MyAccountControl( String Username, String Password, String Password1, String Name)
    {
		 {
			//Customer cusObject = new Customer(CustomerID, Name, Street, City, State1, Zip,Phone, Email, Balance);
            //cusObject.createProfile();
