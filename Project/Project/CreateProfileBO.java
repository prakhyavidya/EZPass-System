...
class CreateProfilePanel extends JPanel implements ActionListener
{
	...
	private String Name, Street, City, State1, Zip, Phone, Email, CustomerID;
	private float Balance;

    public CreateProfilePanel(String CustomerName)
    {
    ...
    public void actionPerformed(ActionEvent evt)  //event handling
    {
        ...
        if (arg.equals("Create")) { //determine which button is clicked
		            ...
		            CreateProfileControl CP_Ctrl = new CreateProfileControl(CustomerID,
		            Name,Street,City,State1,Zip,Phone,Email, Balance);
		}
...
public class CreateProfileBO extends JFrame
{
    ...
    public CreateProfileBO( String CustomerName)
    {
	setTitle("Create Profile");
        setSize(450, 200);
         ...
         CP_Panel = new CreateProfilePanel(CustomerName);
